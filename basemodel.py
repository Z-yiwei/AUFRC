    ...
    def test(self):
        ...
        with torch.no_grad():
            ...
            if self.opt.load_weights:
                path = "./output/{}/{}/train/weights/experiment5_G.pth".format(self.name.lower(), self.opt.dataset)
            ...
            # print("The result is AUC: {.3f}  AUPRC: {:.3f}  ACC: {.3f}  F1-score: {.3f}".format(result_list[0],
            #                                                                                     result_list[1],
            #                                                                                     result_list[2],
            #                                                                                     result_list[3]))
