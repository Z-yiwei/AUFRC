...
class Options():
    ...
    def __init__(self):
        ...
        ##
        # Base
        self.parser.add_argument('--dataset', default='math', help='folder | cifar10 | mnist ')
        self.parser.add_argument('--dataroot', default='./lib/data/math', help='path to dataset')
        ...
        self.parser.add_argument('--manualseed', default=3407, type=int, help='manual seed')
        ...
        ##
        # Train
        # C:\\University\\GANoamly_Project\\skip-ganomaly-master\\output\\skipganomaly\\mono\\train\\weights
        ...
        self.parser.add_argument('--w_lat', type=float, default=2, help='Weight for latent space loss. default=1')
        self.parser.add_argument('--lr_policy', type=str, default='step', help='lambda|step|plateau')
